...
int main(int argc, char* argv[])
{
	...
	if(pFile)
	{
		...
		fprintf(pFile, "    <testcase name=\"TestRsasp1\" classname=\"generic.TestRsasp1\" time=\"0.000\" />\n");
		fprintf(pFile, "  </testsuite>\n");
		fprintf(pFile, "  <testsuite name=\"generic.TestRsavp1\" time=\"0.000\" tests=\"1\" failures=\"0\" errors=\"0\" skipped=\"0\">\n");
		fprintf(pFile, "    <testcase name=\"TestPublicKeySignature\" classname=\"generic.TestRsavp1\" time=\"0.000\" />\n");
		fprintf(pFile, "  </testsuite>\n");
		fprintf(pFile, "  <testsuite name=\"generic.TestSha2\" time=\"0.000\" tests=\"3\" failures=\"0\" errors=\"0\" skipped=\"0\">\n");
		fprintf(pFile, "    <testcase name=\"TestSingle\" classname=\"generic.TestSha2\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestSha2\" classname=\"generic.TestSha2\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestSha2VsSha256\" classname=\"generic.TestSha2\" time=\"0.000\" />\n");
		fprintf(pFile, "  </testsuite>\n");
		fprintf(pFile, "  <testsuite name=\"generic.TestVerifyCertificate\" time=\"0.000\" tests=\"5\" failures=\"0\" errors=\"0\" skipped=\"0\">\n");
		fprintf(pFile, "    <testcase name=\"TestByteswap\" classname=\"generic.TestVerifyCertificate\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestByteswap16\" classname=\"generic.TestVerifyCertificate\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestMontgomeryMultCore\" classname=\"generic.TestVerifyCertificate\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestRsaOnCertificate\" classname=\"generic.TestVerifyCertificate\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestVerifyCertificate\" classname=\"generic.TestVerifyCertificate\" time=\"0.000\" />\n");
		fprintf(pFile, "  </testsuite>\n");
		fprintf(pFile, "  <testsuite name=\"generic.TestPuff\" time=\"0.000\" tests=\"4\" failures=\"0\" errors=\"0\" skipped=\"0\">\n");
		fprintf(pFile, "    <testcase name=\"TestDeflateInflate\" classname=\"generic.TestPuff\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestPuff\" classname=\"generic.TestPuff\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestPuffVector\" classname=\"generic.TestPuff\" time=\"0.000\" />\n");
		fprintf(pFile, "    <testcase name=\"TestPuffErrors\" classname=\"generic.TestPuff\" time=\"0.000\" />\n");
		fprintf(pFile, "  </testsuite>\n");
